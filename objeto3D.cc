...
/*******************************************************************/
/*******************************************************************/
// FUNCION DE PRUEBA FUNCION DE PRUEBA FUNCION DE PRUEBA

void Objeto3D::DibujarNormales(float tam) {
	glColor3b(0,0,0);
	glPointSize(1);
	glBegin(GL_LINES);
	float v1[3], v2[3];
	...
	for (int i = 0; i < vertices.size(); i += 3)
	{
		...
		v2[0] = v1[0] + n_vertices[i] * tam;
		v2[1] = v1[1] + n_vertices[i+1] * tam;
		v2[2] = v1[2] + n_vertices[i+2] * tam;
